...
// Extracted from PQ-Crystals Kyber
        ...
        const unsigned char* input, unsigned long long inlen)
{
    ...
    /* Absorb input */
    keccak_absorb_ledger(s, SHAKE256_RATE, input, inlen, 0x1F);
...
void sha3_256_ledger(unsigned char* output, const unsigned char* input, unsigned long long inlen)
{
    ...
    /* Absorb input */
    keccak_absorb_ledger(s, SHA3_256_RATE, input, inlen, 0x06);
...
void sha3_512_ledger(unsigned char* output, const unsigned char* input, unsigned long long inlen)
{
    ...
    /* Absorb input */
    keccak_absorb_ledger(s, SHA3_512_RATE, input, inlen, 0x06);
